...
goRIGHT: addi    $a0, $zero, 90# Marsbot rotates 180*
jal     ROTATE
...
jal     TRACK           # and draw new track line
goDOWN: addi  $a0, $zero, 180# Marsbotrotates 270*  
jal   ROTATE
...
jal   ROTATE
sleep4: addi    $v0,$zero,32    # Keep running by sleeping in 1000 ms
li      $a0,5000        
syscall
jal     UNTRACK         # keep old track
jal     TRACK           # anddraw new track line
goUP: addi  $a0, $zero, 0# Marsbotrotates 270*  
jal   ROTATE
